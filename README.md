...
[![NPM](https://nodei.co/npm/moesif-cloudflare.png?compact=true&stars=true)](https://nodei.co/npm/moesif-cloudflare/)
...
Cloudflare app to automatically track _outgoing_
API requests and send to Moesif for API debugging and analytics.
